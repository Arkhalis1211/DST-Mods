--Thank you of course to Rezecib for his upvalue hacker for modder's use: https://github.com/rezecib/Rezecib-s-Rebalance/blob/master/scripts/tools/upvaluehacker.lua
UpvalueHacker = {}
