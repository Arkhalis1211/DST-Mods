...
params.bearger_chest.widget.animbank_upgraded = "ui_chester_upgraded_3x4"
params.bearger_chest.widget.animbuild_upgraded = "ui_chester_upgraded_3x4"
...
function params.medal_krampus_chest.itemtestfn(container, item, slot)
    return krampus_chest_white_list[item.prefab] or not (item:HasTag("irreplaceable") or item:HasTag("_container"))
end
