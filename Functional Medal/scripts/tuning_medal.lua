...
TUNING_MEDAL ={
	...
	--方尖锏
	SANITYROCK_MACE_MAX_DAMAGE = TUNING.SPEAR_DAMAGE * 2.5,--方尖锏默认最高伤害
	SANITYROCK_MACE_MIN_DAMAGE = TUNING.SPEAR_DAMAGE * .5,--方尖锏最低伤害
	SANITYROCK_MACE_MOON_DAMAGE = TUNING.SPEAR_DAMAGE * 1.25,--方尖锏月岛伤害
	...
	MEDAL_BUFF_BLEED_DAMAGE = -34,--每秒流血伤害
	--混乱
